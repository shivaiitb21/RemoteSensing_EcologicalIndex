...
var style_KarjatVillagewiseRSEI2020_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("meanRSEIfi");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("VILLNAME") !== null) {
        labelText = String(feature.get("VILLNAME"));
    }
    if (value >= 0.200000 && value <= 0.350000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.350000 && value <= 0.380000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.380000 && value <= 0.410000) {
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(224,255,186,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
                    } else if (value >= 0.410000 && value <= 0.430000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.430000 && value <= 0.515000) {
            style = [ new ol.style.Style({
